...
package Byteflippers is
   ...
   type Signed_8 is range -(2 ** 7) .. (2 ** 7) - 1 with Size => 8;
   ...
   type Signed_16 is range -(2 ** 15) .. (2 ** 15) - 1 with Size => 16;
   ...
   type Signed_24 is range -(2 ** 23) .. (2 ** 23) - 1 with Size => 24;
   ...
   type Signed_64 is range -(2 ** 63) .. (2 ** 63) - 1 with Size => 64;
